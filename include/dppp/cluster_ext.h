...
namespace dppp {
    ...
    inline void get_enhanced_role(dpp::cluster &bot, dpp::snowflake guild_id, dpp::snowflake role_id,
        ...
        get_enhanced_roles(bot, guild_id, [role_id, callback = std::move(callback)](const result<std::vector<enhanced_role>> &list_result) {
    ...
    inline void set_role_colors(dpp::cluster &bot, dpp::snowflake guild_id, dpp::snowflake role_id, const role_colors &colors,
    ...
    inline void set_role_gradient(dpp::cluster &bot, dpp::snowflake guild_id, dpp::snowflake role_id, uint32_t primary,
        ...
        set_role_colours(bot, guild_id, role_id, role_colours::gradient(primary, secondary), std::move(callback), reason);
    }

    inline void set_role_solid_colour(dpp::cluster &bot, dpp::snowflake guild_id, dpp::snowflake role_id, uint32_t colour,
                                      confirm_callback callback = {}, const std::string &reason = {}) {
