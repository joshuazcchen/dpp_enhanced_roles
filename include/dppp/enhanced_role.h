...
namespace dppp {
    ...
    struct enhanced_role {
        ...
        enhanced_role(const enhanced_role &other)
            : id(other.id), name(other.name), guild_id(other.guild_id), position(other.position), colours(other.colours),
              colors(colours), icon_hash(other.icon_hash), unicode_emoji(other.unicode_emoji) {}
