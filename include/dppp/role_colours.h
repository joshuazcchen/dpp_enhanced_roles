...
struct role_colours {
  ...
  role_colours() noexcept
      : primary_colour(0), secondary_colour(std::nullopt),
        tertiary_colour(std::nullopt), primary_color(primary_colour),
        secondary_color(secondary_colour), tertiary_color(tertiary_colour) {}

  explicit role_colours(
      uint32_t primary, std::optional<uint32_t> secondary = std::nullopt,
      std::optional<uint32_t> tertiary = std::nullopt) noexcept
      : primary_colour(primary), secondary_colour(secondary),
        tertiary_colour(tertiary), primary_color(primary_colour),
        secondary_color(secondary_colour), tertiary_color(tertiary_colour) {}

  role_colours(const role_colours &other) noexcept
      : primary_colour(other.primary_colour),
        secondary_colour(other.secondary_colour),
        tertiary_colour(other.tertiary_colour), primary_color(primary_colour),
        secondary_color(secondary_colour), tertiary_color(tertiary_colour) {}
  ...
  role_colours(role_colours &&other) noexcept
      : primary_colour(std::move(other.primary_colour)),
        ...
        primary_color(primary_colour), secondary_color(secondary_colour),
  ...
  [[nodiscard]] role_style style() const noexcept {
    if (tertiary_colour.has_value())
      return role_style::holographic;
    if (secondary_colour.has_value())
      return role_style::gradient;
    return role_style::solid;
  }

  [[nodiscard]] bool is_solid() const noexcept {
    return style() == role_style::solid;
  }
  [[nodiscard]] bool is_gradient() const noexcept {
    return style() == role_style::gradient;
  }
  [[nodiscard]] bool is_holographic() const noexcept {
    return style() == role_style::holographic;
  }
  [[nodiscard]] bool is_enhanced() const noexcept { return !is_solid(); }
  [[nodiscard]] bool is_colourless() const noexcept {
    return primary_colour == 0 && !is_enhanced();
  }
  [[nodiscard]] bool is_colorless() const noexcept { return is_colourless(); }

  [[nodiscard]] std::string primary_hex_colour() const {
    return to_hex_colour(primary_colour);
  }
  [[nodiscard]] std::string primary_hex_color() const {
    return primary_hex_colour();
  }
  ...
  [[nodiscard]] std::optional<std::string> secondary_hex_color() const {
  ...
  [[nodiscard]] std::optional<std::string> tertiary_hex_color() const {
    return tertiary_hex_colour();
  }

  [[nodiscard]] static role_colours holographic() noexcept {
    return role_colours(holographic_style_colours::primary,
                        holographic_style_colours::secondary,
                        holographic_style_colours::tertiary);
  }

  [[nodiscard]] static role_colours gradient(uint32_t primary,
                                             uint32_t secondary) noexcept {
  ...
  [[nodiscard]] static role_colours
  from_role_json(const nlohmann::json &role_json) {
    role_colours rc;
  ...
  bool operator==(const role_colours &other) const noexcept {
    return primary_colour == other.primary_colour &&
           secondary_colour == other.secondary_colour &&
           tertiary_colour == other.tertiary_colour;
  }
